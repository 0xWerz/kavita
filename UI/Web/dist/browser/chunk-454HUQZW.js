...
// src/app/shared/circular-loader/circular-loader.component.ts
var _c0 = (a0, a1) => ({ "width": a0, "height": a1 });
var _c1 = (a0) => ({ "number": a0 });
var _c2 = (a0) => ({ "font-size": a0 });
function CircularLoaderComponent_Conditional_0_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(2, _c1, ctx_r0.center));
    \u0275\u0275advance();
    \u0275\u0275property("ngStyle", \u0275\u0275pureFunction1(4, _c2, ctx_r0.fontSize));
  }
}
function CircularLoaderComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, CircularLoaderComponent_Conditional_0_Conditional_0_Template, 2, 6, "div", 1);
    \u0275\u0275elementStart(1, "div", 0);
    \u0275\u0275element(2, "circle-progress", 2);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275conditional(ctx_r0.showIcon ? 0 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("ngStyle", \u0275\u0275pureFunction2(17, _c0, ctx_r0.width, ctx_r0.height));
    \u0275\u0275advance();
    \u0275\u0275property("percent", ctx_r0.currentValue)("radius", 100)("outerStrokeWidth", 15)("innerStrokeWidth", 0)("space", 0)("backgroundPadding", 0)("outerStrokeColor", ctx_r0.outerStrokeColor)("innerStrokeColor", ctx_r0.innerStrokeColor)("showSubtitle", false)("animation", ctx_r0.animation)("animationDuration", 300)("startFromZero", false)("responsive", true)("backgroundOpacity", 0.5)("backgroundColor", ctx_r0.backgroundColor);
  }
}
var CircularLoaderComponent = class _CircularLoaderComponent {
  constructor() {
    this.currentValue = 0;
    this.animation = true;
    this.innerStrokeColor = "transparent";
    this.outerStrokeColor = "#4ac694";
  ...
  static {
    this.\u0275fac = function CircularLoaderComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _CircularLoaderComponent)();
    };
  }
  static {
    this.\u0275cmp = \u0275\u0275defineComponent({ type: _CircularLoaderComponent, selectors: [["app-circular-loader"]], inputs: { currentValue: "currentValue", animation: "animation", innerStrokeColor: "innerStrokeColor", outerStrokeColor: "outerStrokeColor", backgroundColor: "backgroundColor", fontSize: "fontSize", showIcon: "showIcon", width: "width", height: "height", center: "center" }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 1, vars: 1, consts: [[3, "ngStyle"], [1, "indicator", 3, "ngClass"], ["outerStrokeLinecap", "butt", "titleFontSize", "24", "unitsFontSize", "24", 3, "percent", "radius", "outerStrokeWidth", "innerStrokeWidth", "space", "backgroundPadding", "outerStrokeColor", "innerStrokeColor", "showSubtitle", "animation", "animationDuration", "startFromZero", "responsive", "backgroundOpacity", "backgroundColor"], ["aria-hidden", "true", 1, "fa", "fa-angle-double-down", 3, "ngStyle"]], template: function CircularLoaderComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275template(0, CircularLoaderComponent_Conditional_0_Template, 3, 20, "div", 0);
      }
      if (rf & 2) {
        \u0275\u0275conditional(ctx.currentValue > 0 ? 0 : -1);
      }
    }, dependencies: [NgCircleProgressModule, CircleProgressComponent, NgStyle, NgClass], styles: ["\n\n.number[_ngcontent-%COMP%] {\n  position: absolute;\n  top: 50%;\n  left: 46%;\n  font-size: 18px;\n}\n.indicator[_ngcontent-%COMP%] {\n  font-weight: 500;\n  margin-left: 2px;\n  z-index: 10;\n  color: var(--primary-color);\n  animation: MoveUpDown 1s linear infinite;\n}\n/*# sourceMappingURL=circular-loader.component.css.map */"], changeDetection: 0 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CircularLoaderComponent, { className: "CircularLoaderComponent", filePath: "src/app/shared/circular-loader/circular-loader.component.ts", lineNumber: 13 });
})();
...
//# sourceMappingURL=chunk-454HUQZW.js.map
