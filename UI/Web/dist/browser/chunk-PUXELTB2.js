...
var EVENTS;
(function(EVENTS2) {
  EVENTS2["UpdateAvailable"] = "UpdateAvailable";
  EVENTS2["ScanSeries"] = "ScanSeries";
  EVENTS2["SeriesAdded"] = "SeriesAdded";
  EVENTS2["SeriesRemoved"] = "SeriesRemoved";
  EVENTS2["VolumeRemoved"] = "VolumeRemoved";
  EVENTS2["ChapterRemoved"] = "ChapterRemoved";
  EVENTS2["ScanLibraryProgress"] = "ScanLibraryProgress";
  EVENTS2["OnlineUsers"] = "OnlineUsers";
  EVENTS2["CollectionUpdated"] = "CollectionUpdated";
  EVENTS2["Error"] = "Error";
  EVENTS2["BackupDatabaseProgress"] = "BackupDatabaseProgress";
  EVENTS2["CleanupProgress"] = "CleanupProgress";
  EVENTS2["DownloadProgress"] = "DownloadProgress";
  EVENTS2["NotificationProgress"] = "NotificationProgress";
  EVENTS2["FileScanProgress"] = "FileScanProgress";
  EVENTS2["ScanProgress"] = "ScanProgress";
  EVENTS2["SiteThemeProgress"] = "SiteThemeProgress";
  EVENTS2["CoverUpdate"] = "CoverUpdate";
  EVENTS2["CoverUpdateProgress"] = "CoverUpdateProgress";
  EVENTS2["LibraryModified"] = "LibraryModified";
  EVENTS2["UserProgressUpdate"] = "UserProgressUpdate";
  EVENTS2["UserUpdate"] = "UserUpdate";
  EVENTS2["ConvertBookmarksProgress"] = "ConvertBookmarksProgress";
  EVENTS2["WordCountAnalyzerProgress"] = "WordCountAnalyzerProgress";
  EVENTS2["Info"] = "Info";
  EVENTS2["SendingToDevice"] = "SendingToDevice";
  EVENTS2["ScrobblingKeyExpired"] = "ScrobblingKeyExpired";
  EVENTS2["DashboardUpdate"] = "DashboardUpdate";
  EVENTS2["SideNavUpdate"] = "SideNavUpdate";
  EVENTS2["SiteThemeUpdated"] = "SiteThemeUpdated";
  EVENTS2["SmartCollectionSync"] = "SmartCollectionSync";
})(EVENTS || (EVENTS = {}));
var MessageHubService = class _MessageHubService {
  constructor() {
    this.hubUrl = environment.hubUrl;
    this.messagesSource = new ReplaySubject(1);
  ...
  createHubConnection(user) {
    this.hubConnection = new HubConnectionBuilder().withUrl(this.hubUrl + "messages", {
      accessTokenFactory: () => user.token
    }).withAutomaticReconnect().build();
    this.hubConnection.start().catch((err) => console.error(err));
    this.hubConnection.on(EVENTS.OnlineUsers, (usernames) => {
  ...
  sendMessage(methodName, body) {
    return this.hubConnection.invoke(methodName, body);
  }
  static {
    this.\u0275fac = function MessageHubService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _MessageHubService)();
    };
  }
  static {
    this.\u0275prov = \u0275\u0275defineInjectable({ token: _MessageHubService, factory: _MessageHubService.\u0275fac, providedIn: "root" });
  }
};
...
//# sourceMappingURL=chunk-PUXELTB2.js.map
