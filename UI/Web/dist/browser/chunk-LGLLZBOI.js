...
function Select2_Conditional_8_Conditional_2_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275property("ngTemplateOutlet", ctx_r1.getTemplate(ctx_r1.select2Option, "option"))("ngTemplateOutletContext", ctx_r1.select2Option);
  }
}
function Select2_Conditional_8_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, Select2_Conditional_8_Conditional_2_Conditional_0_Template, 1, 1, "span", 19)(1, Select2_Conditional_8_Conditional_2_Conditional_1_Template, 1, 2, "ng-container");
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275conditional(!ctx_r1.hasTemplate(ctx_r1.select2Option, "option") || ctx_r1.noLabelTemplate ? 0 : 1);
  }
}
function Select2_Conditional_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r1.select2Option ? 1 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.select2Option ? 2 : -1);
    \u0275\u0275advance();
...
function Select2_Conditional_11_For_3_Conditional_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const op_r5 = \u0275\u0275nextContext().$implicit;
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275property("ngTemplateOutlet", ctx_r1.getTemplate(op_r5, "option"))("ngTemplateOutletContext", op_r5);
  }
}
function Select2_Conditional_11_For_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, Select2_Conditional_11_For_3_Conditional_1_Template, 2, 0, "span", 26)(2, Select2_Conditional_11_For_3_Conditional_2_Template, 1, 1, "span", 19)(3, Select2_Conditional_11_For_3_Conditional_3_Template, 1, 2, "ng-container");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(!(ctx_r1.disabled || ctx_r1.readonly) ? 1 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r1.hasTemplate(op_r5, "option") || ctx_r1.noLabelTemplate ? 2 : 3);
  }
}
...
function Select2_Conditional_11_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r1.autoCreate ? 1 : -1);
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r1.option || \u0275\u0275pureFunction0(2, _c7));
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.autoCreate ? 4 : -1);
  }
}
...
function Select2_ng_template_16_For_10_Conditional_0_For_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(2, Select2_ng_template_16_For_10_Conditional_0_For_5_Conditional_2_Template, 1, 1, "div", 43)(3, Select2_ng_template_16_For_10_Conditional_0_For_5_Conditional_3_Template, 1, 2, "ng-container");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const option_r12 = ctx.$implicit;
    const \u0275$index_108_r13 = ctx.$index;
    const \u0275$index_94_r14 = \u0275\u0275nextContext(2).$index;
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275classMap(ctx_r1.getOptionStyle(option_r12));
    \u0275\u0275property("id", option_r12.id || ctx_r1.id + "-option-" + \u0275$index_94_r14 + "-" + \u0275$index_108_r13);
    \u0275\u0275attribute("aria-selected", ctx_r1.isSelected(option_r12))("aria-disabled", ctx_r1.isDisabled(option_r12));
    \u0275\u0275advance(2);
    \u0275\u0275conditional(!ctx_r1.hasTemplate(option_r12, "option") ? 2 : 3);
  }
}
function Select2_ng_template_16_For_10_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li", 39);
    \u0275\u0275template(1, Select2_ng_template_16_For_10_Conditional_0_Conditional_1_Template, 1, 2, "strong", 19)(2, Select2_ng_template_16_For_10_Conditional_0_Conditional_2_Template, 1, 2, "ng-container");
    \u0275\u0275elementStart(3, "ul", 41);
    \u0275\u0275repeaterCreate(4, Select2_ng_template_16_For_10_Conditional_0_For_5_Template, 4, 6, "li", 40, \u0275\u0275componentInstance().trackBy, true);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r1.hasTemplate(groupOrOption_r10, "group") ? 1 : 2);
    \u0275\u0275advance(3);
...
function Select2_ng_template_16_For_10_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(2, Select2_ng_template_16_For_10_Conditional_1_Conditional_2_Template, 1, 1, "div", 43)(3, Select2_ng_template_16_For_10_Conditional_1_Conditional_3_Template, 1, 2, "ng-container")(4, Select2_ng_template_16_For_10_Conditional_1_ng_template_4_Template, 1, 2, "ng-template", null, 6, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275property("id", groupOrOption_r10.id || ctx_r1.id + "-option-" + \u0275$index_94_r14);
    \u0275\u0275attribute("aria-selected", ctx_r1.isSelected(groupOrOption_r10))("aria-disabled", ctx_r1.isDisabled(groupOrOption_r10));
    \u0275\u0275advance(2);
    \u0275\u0275conditional(!ctx_r1.hasTemplate(groupOrOption_r10, "option") ? 2 : 3);
  }
}
function Select2_ng_template_16_For_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, Select2_ng_template_16_For_10_Conditional_0_Template, 6, 1, "li", 39)(1, Select2_ng_template_16_For_10_Conditional_1_Template, 6, 6, "li", 40);
  }
  if (rf & 2) {
    const groupOrOption_r10 = ctx.$implicit;
    \u0275\u0275conditional(groupOrOption_r10.options !== void 0 ? 0 : 1);
  }
}
...
function Select2_ng_template_16_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional(!(ctx_r1.filteredData == null ? null : ctx_r1.filteredData.length) && ctx_r1.noResultMessage ? 11 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.maxResultsExceeded ? 12 : -1);
  }
}
var unicodePatterns = [{
  l: "a",
    ...
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
      ...
      template: function Select2_Template(rf, ctx) {
        if (rf & 1) {
          ...
          \u0275\u0275template(16, Select2_ng_template_16_Template, 13, 25, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
        }
        if (rf & 2) {
          ...
          \u0275\u0275advance();
          \u0275\u0275conditional(!ctx.multiple ? 8 : -1);
          \u0275\u0275advance();
          \u0275\u0275conditional(!ctx.multiple && ctx.resettable && ctx.resetSelectedValue !== ctx.value && ctx.select2Option && !(ctx.disabled || ctx.readonly) ? 9 : -1);
          \u0275\u0275advance();
          \u0275\u0275conditional(!ctx.multiple ? 10 : -1);
          \u0275\u0275advance();
          \u0275\u0275conditional(ctx.multiple ? 11 : -1);
          \u0275\u0275advance();
          \u0275\u0275conditional(!ctx.overlay ? 12 : -1);
          \u0275\u0275advance(3);
    ...
    >
        ...
        >
            ...
            @if (!multiple && resettable && resetSelectedValue !== value && select2Option && !(disabled || readonly)) {
                <span (click)="reset($event)" class="select2-selection__reset" role="presentation">\xD7</span>
            }
            @if (!multiple) {
...
//# sourceMappingURL=chunk-LGLLZBOI.js.map
