...
// src/app/_services/action-factory.service.ts
var Action;
(function(Action2) {
  Action2[Action2["Submenu"] = -1] = "Submenu";
  Action2[Action2["MarkAsRead"] = 0] = "MarkAsRead";
  Action2[Action2["MarkAsUnread"] = 1] = "MarkAsUnread";
  Action2[Action2["Scan"] = 2] = "Scan";
  Action2[Action2["Delete"] = 3] = "Delete";
  Action2[Action2["Edit"] = 4] = "Edit";
  Action2[Action2["Info"] = 5] = "Info";
  Action2[Action2["RefreshMetadata"] = 6] = "RefreshMetadata";
  Action2[Action2["Download"] = 7] = "Download";
  Action2[Action2["AnalyzeFiles"] = 8] = "AnalyzeFiles";
  Action2[Action2["IncognitoRead"] = 9] = "IncognitoRead";
  Action2[Action2["AddToReadingList"] = 10] = "AddToReadingList";
  Action2[Action2["AddToCollection"] = 11] = "AddToCollection";
  Action2[Action2["DownloadBookmark"] = 12] = "DownloadBookmark";
  Action2[Action2["ViewSeries"] = 13] = "ViewSeries";
  Action2[Action2["Read"] = 14] = "Read";
  Action2[Action2["AddToWantToReadList"] = 15] = "AddToWantToReadList";
  Action2[Action2["RemoveFromWantToReadList"] = 16] = "RemoveFromWantToReadList";
  Action2[Action2["SendTo"] = 17] = "SendTo";
  Action2[Action2["Import"] = 18] = "Import";
  Action2[Action2["RemoveFromOnDeck"] = 19] = "RemoveFromOnDeck";
  Action2[Action2["AddRuleGroup"] = 20] = "AddRuleGroup";
  Action2[Action2["RemoveRuleGroup"] = 21] = "RemoveRuleGroup";
  Action2[Action2["MarkAsVisible"] = 22] = "MarkAsVisible";
  Action2[Action2["MarkAsInvisible"] = 23] = "MarkAsInvisible";
  Action2[Action2["Promote"] = 24] = "Promote";
  Action2[Action2["UnPromote"] = 25] = "UnPromote";
  Action2[Action2["GenerateColorScape"] = 26] = "GenerateColorScape";
  Action2[Action2["CopySettings"] = 27] = "CopySettings";
  Action2[Action2["Match"] = 28] = "Match";
})(Action || (Action = {}));
var ActionFactoryService = class _ActionFactoryService {
  constructor(accountService, deviceService) {
  ...
  getActionablesForSettingsPage(actions, blacklist = []) {
    ...
    for (let parent of actions) {
      ...
      for (let child of parent.children) {
        if (child.action === Action.SendTo)
          continue;
        actionItem = __spreadValues({}, child);
        actionItem.title = translate("actionable." + actionItem.title);
        if (actionItem.description !== "") {
          actionItem.description = translate("actionable." + actionItem.description);
        }
  ...
  getBulkLibraryActions(callback) {
  ...
  flattenActions(actions) {
    return actions.reduce((flatArray, action) => {
      ...
      if (action.children && action.children.length > 0) {
        flatArray.push(...this.flattenActions(action.children));
      }
      return flatArray;
    }, []);
  }
  ...
  applyCallbackToList(list, callback) {
  ...
  hasAction(actions, action) {
    ...
    for (let i = 0; i < actions.length; i++) {
      if (actions[i].action === action)
        return true;
      if (this.hasAction(actions[i].children, action))
        return true;
    }
    return false;
  }
  static {
    this.\u0275fac = function ActionFactoryService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _ActionFactoryService)(\u0275\u0275inject(AccountService), \u0275\u0275inject(DeviceService));
    };
  }
  static {
    this.\u0275prov = \u0275\u0275defineInjectable({ token: _ActionFactoryService, factory: _ActionFactoryService.\u0275fac, providedIn: "root" });
  }
};

// src/app/_services/license.service.ts
var LicenseService = class _LicenseService {
  constructor() {
    this.httpClient = inject(HttpClient);
    this.baseUrl = environment.apiUrl;
    this.hasValidLicenseSource = new ReplaySubject(1);
    this.hasValidLicense$ = this.hasValidLicenseSource.asObservable();
  }
  deleteLicense() {
    return this.httpClient.delete(this.baseUrl + "license", TextResonse).pipe(map((res) => res === "true"), tap((_) => {
  ...
  resetLicense(license, email) {
    return this.httpClient.post(this.baseUrl + "license/reset", { license, email }, TextResonse);
  }
  licenseInfo(forceCheck = false) {
    return this.httpClient.get(this.baseUrl + `license/info?forceCheck=${forceCheck}`).pipe(tap((res) => {
  ...
  hasValidLicense(forceCheck = false) {
    console.log("hasValidLicense being called: ", forceCheck);
    return this.httpClient.get(this.baseUrl + "license/valid-license?forceCheck=" + forceCheck, TextResonse).pipe(map((res) => res === "true"), tap((res) => {
  ...
  hasAnyLicense() {
    return this.httpClient.get(this.baseUrl + "license/has-license", TextResonse).pipe(map((res) => res === "true"));
  }
  updateUserLicense(license, email, discordId) {
    return this.httpClient.post(this.baseUrl + "license", { license, email, discordId }, TextResonse).pipe(map((res) => res === "true"));
  }
  static {
    this.\u0275fac = function LicenseService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _LicenseService)();
    };
  }
  static {
    this.\u0275prov = \u0275\u0275defineInjectable({ token: _LicenseService, factory: _LicenseService.\u0275fac, providedIn: "root" });
  }
};

// src/app/_services/localization.service.ts
var LocalizationService = class _LocalizationService {
  constructor(httpClient) {
    ...
    this.locales$ = this.localeSubject.asObservable();
  }
  getLocales() {
  ...
  static {
    this.\u0275fac = function LocalizationService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _LocalizationService)(\u0275\u0275inject(HttpClient));
    };
  }
  static {
    this.\u0275prov = \u0275\u0275defineInjectable({ token: _LocalizationService, factory: _LocalizationService.\u0275fac, providedIn: "root" });
  }
};

// src/app/_models/preferences/site-theme.ts
var ThemeProvider;
(function(ThemeProvider2) {
  ThemeProvider2[ThemeProvider2["System"] = 1] = "System";
  ThemeProvider2[ThemeProvider2["Custom"] = 2] = "Custom";
})(ThemeProvider || (ThemeProvider = {}));

// src/app/_services/colorscape.service.ts
var colorScapeSelector = "colorscape";
var ColorscapeService = class _ColorscapeService {
  constructor(document, router) {
    this.document = document;
    this.router = router;
    this.colorSubject = new BehaviorSubject(null);
    this.colorSeedSubject = new BehaviorSubject(null);
    this.colors$ = this.colorSubject.asObservable();
    this.minDuration = 1e3;
    this.maxDuration = 4e3;
    this.defaultColorspaceDuration = 300;
    this.router.events.pipe(filter((event) => event instanceof NavigationEnd), tap(() => this.checkAndResetColorscapeAfterDelay())).subscribe();
  }
  checkAndResetColorscapeAfterDelay() {
    const initialColors = this.colorSubject.getValue();
    timer(this.defaultColorspaceDuration).pipe(take(1), tap(() => {
  ...
  setColorScape(primaryColor, complementaryColor = null) {
    ...
    this.colorSeedSubject.next({ primary: primaryColor, complementary: complementaryColor });
    const newColors = primaryColor ? this.generateBackgroundColors(primaryColor, complementaryColor, this.isDarkTheme()) : this.defaultColors();
  ...
  areColorSpacesVisuallyEqual(color1, color2, threshold = 0) {
    return this.areRGBAColorsVisuallyEqual(color1.primary, color2.primary, threshold) && this.areRGBAColorsVisuallyEqual(color1.lighter, color2.lighter, threshold) && this.areRGBAColorsVisuallyEqual(color1.darker, color2.darker, threshold) && this.areRGBAColorsVisuallyEqual(color1.complementary, color2.complementary, threshold);
  }
  areRGBAColorsVisuallyEqual(color1, color2, threshold = 0) {
    return Math.abs(color1.r - color2.r) <= threshold && Math.abs(color1.g - color2.g) <= threshold && Math.abs(color1.b - color2.b) <= threshold && Math.abs(color1.a - color2.a) <= threshold / 255;
  }
  convertColorsToRGBA(colors) {
    return {
  ...
  calculateTransitionDuration(oldColors, newColors) {
    ...
    const normalizedDistance = Math.min(totalDistance / (255 * 3 * 4), 1);
  ...
  animateColorTransition(oldColors, newColors, duration) {
  ...
  interpolateRGBAColor(color1, color2, progress) {
  ...
  setColorsImmediately(colors) {
    this.injectStyleElement(colorScapeSelector, `
      :root, :root .default {
        ...
        --colorscape-primary-no-alpha-color: ${this.rgbaToString(__spreadProps(__spreadValues({}, colors.primary), { a: 0 }))};
        --colorscape-lighter-no-alpha-color: ${this.rgbaToString(__spreadProps(__spreadValues({}, colors.lighter), { a: 0 }))};
        --colorscape-darker-no-alpha-color: ${this.rgbaToString(__spreadProps(__spreadValues({}, colors.darker), { a: 0 }))};
        --colorscape-complementary-no-alpha-color: ${this.rgbaToString(__spreadProps(__spreadValues({}, colors.complementary), { a: 0 }))};
        --colorscape-primary-full-alpha-color: ${this.rgbaToString(__spreadProps(__spreadValues({}, colors.primary), { a: 1 }))};
        --colorscape-lighter-full-alpha-color: ${this.rgbaToString(__spreadProps(__spreadValues({}, colors.lighter), { a: 1 }))};
        --colorscape-darker-full-alpha-color: ${this.rgbaToString(__spreadProps(__spreadValues({}, colors.darker), { a: 1 }))};
        --colorscape-complementary-full-alpha-color: ${this.rgbaToString(__spreadProps(__spreadValues({}, colors.complementary), { a: 1 }))};
        --colorscape-primary-half-alpha-color: ${this.rgbaToString(__spreadProps(__spreadValues({}, colors.primary), { a: 0.5 }))};
        --colorscape-lighter-half-alpha-color: ${this.rgbaToString(__spreadProps(__spreadValues({}, colors.lighter), { a: 0.5 }))};
        --colorscape-darker-half-alpha-color: ${this.rgbaToString(__spreadProps(__spreadValues({}, colors.darker), { a: 0.5 }))};
        --colorscape-complementary-half-alpha-color: ${this.rgbaToString(__spreadProps(__spreadValues({}, colors.complementary), { a: 0.5 }))};
      }
    `);
  }
  generateBackgroundColors(primaryColor, secondaryColor = null, isDarkTheme = true) {
    ...
    return isDarkTheme ? this.calculateDarkThemeColors(secondaryHSL, primaryHSL, primary) : this.calculateLightThemeDarkColors(primaryHSL, primary);
  }
  adjustColorWithVariance(color) {
    const rgb = this.hexToRgb(color);
    const randomVariance = () => this.getRandomInRange(-10, 10);
  ...
  calculateLightThemeDarkColors(primaryHSL, primary) {
    const lighterHSL = __spreadValues({}, primaryHSL);
    lighterHSL.s = Math.max(lighterHSL.s - 0.3, 0);
    lighterHSL.l = Math.min(lighterHSL.l + 0.5, 0.95);
    const darkerHSL = __spreadValues({}, primaryHSL);
  ...
  calculateDarkThemeColors(secondaryHSL, primaryHSL, primary) {
  ...
  static {
    this.\u0275fac = function ColorscapeService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _ColorscapeService)(\u0275\u0275inject(DOCUMENT), \u0275\u0275inject(Router));
    };
  }
  static {
    this.\u0275prov = \u0275\u0275defineInjectable({ token: _ColorscapeService, factory: _ColorscapeService.\u0275fac, providedIn: "root" });
  }
};

// src/app/_services/theme.service.ts
var ThemeService = class _ThemeService {
  constructor(rendererFactory, document, httpClient, messageHub, domSanitizer, confirmService, toastr, router) {
    this.document = document;
    this.httpClient = httpClient;
    ...
    this.colorTransitionService = inject(ColorscapeService);
    this.defaultTheme = "dark";
    this.defaultBookTheme = "Dark";
    this.currentThemeSource = new ReplaySubject(1);
    this.currentTheme$ = this.currentThemeSource.asObservable();
    this.themesSource = new ReplaySubject(1);
    this.themes$ = this.themesSource.asObservable();
    this.darkModeSource = new ReplaySubject(1);
    this.isDarkMode$ = this.darkModeSource.asObservable();
    this.themeCache = [];
    this.baseUrl = environment.apiUrl;
    ...
    messageHub.messages$.pipe(takeUntilDestroyed(this.destroyRef)).subscribe((message) => {
      if (message.event === EVENTS.NotificationProgress) {
        const notificationEvent = message.payload;
  ...
  getDownloadableThemes() {
    return this.httpClient.get(this.baseUrl + "theme/browse");
  }
  downloadTheme(theme) {
    return this.httpClient.post(this.baseUrl + "theme/download-theme", theme);
  }
  uploadTheme(themeFile, fileEntry) {
    const formData = new FormData();
    formData.append("formFile", themeFile, fileEntry.relativePath);
    return this.httpClient.post(this.baseUrl + "theme/upload-theme", formData);
  }
  getColorScheme() {
  ...
  setDefault(themeId) {
    return this.httpClient.post(this.baseUrl + "theme/update-default", { themeId }).pipe(map(() => {
      this.getThemes().subscribe(() => {
      });
    }));
  }
  setBookTheme(selector) {
  ...
  refreshColorScape(entity, id) {
    return this.httpClient.get(`${this.baseUrl}colorscape/${entity}?id=${id}`).pipe(tap((cs) => {
  ...
  setTheme(themeName) {
    ...
    if (theme) {
      ...
      if (theme.provider !== ThemeProvider.System && !this.hasThemeInHead(theme.name)) {
        this.fetchThemeContent(theme.id).subscribe((content) => __async(this, null, function* () {
          if (content === null) {
            yield this.confirmService.alert(translate("toasts.alert-bad-theme"));
            this.setTheme("dark");
            return;
          }
  ...
  static {
    this.\u0275fac = function ThemeService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _ThemeService)(\u0275\u0275inject(RendererFactory2), \u0275\u0275inject(DOCUMENT), \u0275\u0275inject(HttpClient), \u0275\u0275inject(MessageHubService), \u0275\u0275inject(DomSanitizer), \u0275\u0275inject(ConfirmService), \u0275\u0275inject(ToastrService), \u0275\u0275inject(Router));
    };
  }
  static {
    this.\u0275prov = \u0275\u0275defineInjectable({ token: _ThemeService, factory: _ThemeService.\u0275fac, providedIn: "root" });
  }
};
...
(function(Role2) {
  Role2["Admin"] = "Admin";
  Role2["ChangePassword"] = "Change Password";
  Role2["Bookmark"] = "Bookmark";
  Role2["Download"] = "Download";
  Role2["ChangeRestriction"] = "Change Restriction";
  Role2["ReadOnly"] = "Read Only";
  Role2["Login"] = "Login";
  Role2["Promote"] = "Promote";
})(Role || (Role = {}));
var allRoles = [
  Role.Admin,
  Role.ChangePassword,
...
var AccountService = class _AccountService {
  static {
    this.lastLoginKey = "kavita-lastlogin";
  }
  static {
    this.localeKey = "kavita-locale";
  }
  constructor(httpClient, router, messageHub, themeService) {
    this.httpClient = httpClient;
    this.router = router;
    ...
    this.baseUrl = environment.apiUrl;
    this.userKey = "kavita-user";
    this.currentUserSource = new ReplaySubject(1);
    this.currentUser$ = this.currentUserSource.asObservable().pipe(takeUntilDestroyed(this.destroyRef), shareReplay({ bufferSize: 1, refCount: true }));
    this.isAdmin$ = this.currentUser$.pipe(takeUntilDestroyed(this.destroyRef), map((u) => {
      if (!u)
        return false;
      return this.hasAdminRole(u);
    }), shareReplay({ bufferSize: 1, refCount: true }));
    this.isOnline = true;
    messageHub.messages$.pipe(filter((evt) => evt.event === EVENTS.UserUpdate), map((evt) => evt.payload), filter((userUpdateEvent) => userUpdateEvent.userName === this.currentUser?.username), switchMap(() => this.refreshAccount())).subscribe(() => {
    });
  ...
  canInvokeAction(user, action) {
    ...
    if (action === Action.Download)
      return canDownload;
    if (action === Action.Promote || action === Action.UnPromote)
      return canPromote;
    if (action === Action.Delete)
      return isAdmin;
    return true;
  }
  hasAnyRole(user, roles, restrictedRoles = []) {
    if (!user || !user.roles) {
      return false;
    }
  ...
  login(model) {
    return this.httpClient.post(this.baseUrl + "account/login", model).pipe(tap((response) => {
      const user = response;
      if (user) {
  ...
  setCurrentUser(user, refreshConnections = true) {
    ...
    if (user) {
      ...
      localStorage.setItem(_AccountService.lastLoginKey, user.username);
  ...
  logout() {
    ...
    this.currentUserSource.next(void 0);
  ...
  register(model) {
    return this.httpClient.post(this.baseUrl + "account/register", model).pipe(map((user) => {
      return user;
    }), takeUntilDestroyed(this.destroyRef));
  }
  isEmailConfirmed() {
  ...
  isEmailValid() {
    return this.httpClient.get(this.baseUrl + "account/is-email-valid", TextResonse).pipe(map((res) => res == "true"));
  }
  confirmMigrationEmail(model) {
    return this.httpClient.post(this.baseUrl + "account/confirm-migration-email", model);
  }
  resendConfirmationEmail(userId) {
    return this.httpClient.post(this.baseUrl + "account/resend-confirmation-email?userId=" + userId, {});
  }
  inviteUser(model) {
  ...
  updateAgeRestriction(ageRating, includeUnknowns) {
  ...
  getPreferences() {
    return this.httpClient.get(this.baseUrl + "users/get-preferences").pipe(map((pref) => {
      if (this.currentUser !== void 0 && this.currentUser !== null) {
  ...
  updatePreferences(userPreferences) {
    return this.httpClient.post(this.baseUrl + "users/update-preferences", userPreferences).pipe(map((settings) => {
      if (this.currentUser !== void 0 && this.currentUser !== null) {
        ...
        localStorage.setItem(_AccountService.localeKey, this.currentUser.preferences.locale);
  ...
  refreshAccount() {
    if (this.currentUser === null || this.currentUser === void 0)
      return of();
    return this.httpClient.get(this.baseUrl + "account/refresh-account").pipe(map((user) => {
      if (user) {
        this.currentUser = __spreadValues({}, user);
      }
      this.setCurrentUser(this.currentUser);
      return user;
    }));
  ...
  refreshToken() {
    if (this.currentUser === null || this.currentUser === void 0 || !this.isOnline)
      return of();
    return this.httpClient.post(this.baseUrl + "account/refresh-token", { token: this.currentUser.token, refreshToken: this.currentUser.refreshToken }).pipe(map((user) => {
      if (this.currentUser) {
  ...
  stopRefreshTokenTimer() {
    if (this.refreshTokenTimeout !== void 0) {
      clearInterval(this.refreshTokenTimeout);
    }
  }
  static {
    this.\u0275fac = function AccountService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _AccountService)(\u0275\u0275inject(HttpClient), \u0275\u0275inject(Router), \u0275\u0275inject(MessageHubService), \u0275\u0275inject(ThemeService));
    };
  }
  static {
    this.\u0275prov = \u0275\u0275defineInjectable({ token: _AccountService, factory: _AccountService.\u0275fac, providedIn: "root" });
  }
};

// src/app/_services/device.service.ts
var DeviceService = class _DeviceService {
  constructor(httpClient, accountService) {
    this.httpClient = httpClient;
    this.accountService = accountService;
    this.baseUrl = environment.apiUrl;
    this.devicesSource = new ReplaySubject(1);
    this.devices$ = this.devicesSource.asObservable().pipe(shareReplay());
    this.accountService.currentUser$.subscribe((user) => {
      if (!user) {
  ...
  createDevice(name, platform, emailAddress) {
    return this.httpClient.post(this.baseUrl + "device/create", { name, platform, emailAddress });
  }
  updateDevice(id, name, platform, emailAddress) {
    return this.httpClient.post(this.baseUrl + "device/update", { id, name, platform, emailAddress });
  }
  deleteDevice(id) {
  ...
  static {
    this.\u0275fac = function DeviceService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _DeviceService)(\u0275\u0275inject(HttpClient), \u0275\u0275inject(AccountService));
    };
  }
  static {
    this.\u0275prov = \u0275\u0275defineInjectable({ token: _DeviceService, factory: _DeviceService.\u0275fac, providedIn: "root" });
  }
};
...
@angular/router/fesm2022/router.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-U2DWQJI2.js.map
