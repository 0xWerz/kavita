...
// src/app/_models/reading-list/cbl/cbl-import-reason.enum.ts
var CblImportReason;
(function(CblImportReason2) {
  CblImportReason2[CblImportReason2["ChapterMissing"] = 0] = "ChapterMissing";
  CblImportReason2[CblImportReason2["VolumeMissing"] = 1] = "VolumeMissing";
  CblImportReason2[CblImportReason2["SeriesMissing"] = 2] = "SeriesMissing";
  CblImportReason2[CblImportReason2["NameConflict"] = 3] = "NameConflict";
  CblImportReason2[CblImportReason2["AllSeriesMissing"] = 4] = "AllSeriesMissing";
  CblImportReason2[CblImportReason2["EmptyFile"] = 5] = "EmptyFile";
  CblImportReason2[CblImportReason2["SeriesCollision"] = 6] = "SeriesCollision";
  CblImportReason2[CblImportReason2["AllChapterMissing"] = 7] = "AllChapterMissing";
  CblImportReason2[CblImportReason2["Success"] = 8] = "Success";
  CblImportReason2[CblImportReason2["InvalidFile"] = 9] = "InvalidFile";
})(CblImportReason || (CblImportReason = {}));

// src/app/_pipes/cbl-conflict-reason.pipe.ts
var failIcon = '<i aria-hidden="true" class="reading-list-fail--item fa-solid fa-circle-xmark me-1"></i>';
var successIcon = '<i aria-hidden="true" class="reading-list-success--item fa-solid fa-circle-check me-1"></i>';
var CblConflictReasonPipe = class _CblConflictReasonPipe {
  constructor() {
  ...
  static {
    this.\u0275fac = function CblConflictReasonPipe_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _CblConflictReasonPipe)();
    };
  }
  static {
    this.\u0275pipe = \u0275\u0275definePipe({ name: "cblConflictReason", type: _CblConflictReasonPipe, pure: true, standalone: true });
  }
};

// src/app/_models/reading-list/cbl/cbl-import-result.enum.ts
var CblImportResult;
(function(CblImportResult2) {
  CblImportResult2[CblImportResult2["Fail"] = 0] = "Fail";
  CblImportResult2[CblImportResult2["Partial"] = 1] = "Partial";
  CblImportResult2[CblImportResult2["Success"] = 2] = "Success";
})(CblImportResult || (CblImportResult = {}));

// src/app/_pipes/cbl-import-result.pipe.ts
var CblImportResultPipe = class _CblImportResultPipe {
  constructor() {
    this.translocoService = inject(TranslocoService);
  }
  transform(result) {
  ...
  static {
    this.\u0275fac = function CblImportResultPipe_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _CblImportResultPipe)();
    };
  }
  static {
    this.\u0275pipe = \u0275\u0275definePipe({ name: "cblImportResult", type: _CblImportResultPipe, pure: true, standalone: true });
  }
};
...
function FileUploadComponent_ng_template_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(isFileDragDropAvailable_r2 ? 1 : 2);
  }
}
...
function FileUploadComponent_Conditional_7_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngTemplateOutlet", ctx_r3.listItem ? ctx_r3.listItem : defaultItemTemplate_r7)("ngTemplateOutletContext", \u0275\u0275pureFunction4(2, _c5, file_r5, file_r5, \u0275$index_33_r6, ctx_r3.control));
  }
}
...
function SimpleFileUploadComponent_ng_template_3_For_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275conditional(\u0275$index_11_r5 > 0 ? 0 : -1);
    \u0275\u0275advance(2);
...
var FileUploadService = class _FileUploadService {
  ...
  static {
    this.\u0275fac = function FileUploadService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _FileUploadService)(\u0275\u0275inject(Renderer2));
    };
  }
  static {
...
var FileUploadAbstract = class _FileUploadAbstract {
  constructor() {
    this.control = null;
  ...
  static {
    this.\u0275fac = function FileUploadAbstract_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _FileUploadAbstract)();
    };
  }
  static {
...
var FileUploadDropZoneComponent = class _FileUploadDropZoneComponent {
  static {
    this.\u0275fac = function FileUploadDropZoneComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _FileUploadDropZoneComponent)();
    };
  }
  static {
...
var FileUploadIconComponent = class _FileUploadIconComponent {
  ...
  static {
    this.\u0275fac = function FileUploadIconComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _FileUploadIconComponent)(\u0275\u0275directiveInject(FileUploadService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
      ...
      template: function FileUploadIconComponent_Template(rf, ctx) {
        if (rf & 1) {
          \u0275\u0275template(0, FileUploadIconComponent_Case_0_Template, 3, 0, ":svg:svg", 0)(1, FileUploadIconComponent_Case_1_Template, 3, 0, ":svg:svg", 0)(2, FileUploadIconComponent_Case_2_Template, 3, 0, ":svg:svg", 0)(3, FileUploadIconComponent_Case_3_Template, 3, 0, ":svg:svg", 0)(4, FileUploadIconComponent_Case_4_Template, 3, 0, ":svg:svg", 0);
        }
        if (rf & 2) {
          let tmp_0_0;
          \u0275\u0275conditional((tmp_0_0 = ctx.comparationType()) === "image" ? 0 : tmp_0_0 === "audio" ? 1 : tmp_0_0 === "text" ? 2 : tmp_0_0 === "video" ? 3 : 4);
        }
      },
...
var FileUploadListItemComponent = class _FileUploadListItemComponent {
  constructor(fileUploadService) {
    this.fileUploadService = fileUploadService;
  }
  removeFile(file) {
  ...
  static {
    this.\u0275fac = function FileUploadListItemComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _FileUploadListItemComponent)(\u0275\u0275directiveInject(FileUploadService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
...
var FileUploadComponent = class _FileUploadComponent extends FileUploadAbstract {
  ...
  static {
    this.\u0275fac = function FileUploadComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _FileUploadComponent)(\u0275\u0275directiveInject(FileUploadService), \u0275\u0275directiveInject(DOCUMENT));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
      ...
      template: function FileUploadComponent_Template(rf, ctx) {
        ...
        if (rf & 2) {
          ...
          \u0275\u0275advance(5);
          \u0275\u0275conditional(\u0275\u0275pipeBind1(8, 4, ctx.control.listVisibilityChanges) && ctx.control.size > 0 && ctx.listVisible ? 7 : -1);
        }
      },
...
var FileUploadAttributeComponent = class _FileUploadAttributeComponent {
  ...
  static {
    this.\u0275fac = function FileUploadAttributeComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _FileUploadAttributeComponent)(\u0275\u0275directiveInject(FileUploadService), \u0275\u0275directiveInject(ElementRef), \u0275\u0275directiveInject(Renderer2), \u0275\u0275directiveInject(DOCUMENT));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
      ...
      template: function FileUploadAttributeComponent_Template(rf, ctx) {
        ...
        if (rf & 2) {
          \u0275\u0275advance();
          \u0275\u0275conditional(ctx.fileUploadService.isFileDragDropAvailable() ? 1 : -1);
        }
      },
...
var SimpleFileUploadComponent = class _SimpleFileUploadComponent extends FileUploadAbstract {
  constructor(fileUploadService) {
    super();
    this.fileUploadService = fileUploadService;
    this.control = null;
  ...
  static {
    this.\u0275fac = function SimpleFileUploadComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _SimpleFileUploadComponent)(\u0275\u0275directiveInject(FileUploadService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
      ...
      template: function SimpleFileUploadComponent_Template(rf, ctx) {
        ...
        if (rf & 2) {
          ...
          \u0275\u0275advance();
          \u0275\u0275conditional(\u0275\u0275pipeBind1(2, 3, ctx.control.valueChanges) ? 1 : -1);
          \u0275\u0275advance(6);
...
var FileSizeValidator = class _FileSizeValidator {
  constructor(fileUploadService) {
    this.fileUploadService = fileUploadService;
  }
  ngOnChanges(changes) {
  ...
  static {
    this.\u0275fac = function FileSizeValidator_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _FileSizeValidator)(\u0275\u0275directiveInject(FileUploadService));
    };
  }
  static {
    this.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
...
var FilesLimitValidator = class _FilesLimitValidator {
  ngOnChanges(changes) {
  ...
  static {
    this.\u0275fac = function FilesLimitValidator_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _FilesLimitValidator)();
    };
  }
  static {
    this.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
...
var FilesAcceptValidator = class _FilesAcceptValidator {
  ngOnChanges(changes) {
  ...
  static {
    this.\u0275fac = function FilesAcceptValidator_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _FilesAcceptValidator)();
    };
  }
  static {
    this.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
...
var FilesAcceptDirective = class _FilesAcceptDirective {
  ...
  static {
    this.\u0275fac = function FilesAcceptDirective_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _FilesAcceptDirective)(\u0275\u0275directiveInject(FileUploadComponent, 11), \u0275\u0275directiveInject(SimpleFileUploadComponent, 11));
    };
  }
  static {
    this.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
...
var FilesDiscardDirective = class _FilesDiscardDirective {
  set discard(discard) {
  ...
  static {
    this.\u0275fac = function FilesDiscardDirective_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _FilesDiscardDirective)(\u0275\u0275directiveInject(FileUploadComponent, 11), \u0275\u0275directiveInject(SimpleFileUploadComponent, 11));
    };
  }
  static {
    this.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
...
var FilesNativeDirective = class _FilesNativeDirective {
  set native(isNative) {
  ...
  static {
    this.\u0275fac = function FilesNativeDirective_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _FilesNativeDirective)(\u0275\u0275directiveInject(FileUploadComponent, 11), \u0275\u0275directiveInject(SimpleFileUploadComponent, 11));
    };
  }
  static {
    this.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
...
// src/app/reading-list/_components/step-tracker/step-tracker.component.ts
var _c02 = (a0) => ({ "active": a0 });
function StepTrackerComponent_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "li", 3)(2, "div");
    \u0275\u0275element(3, "i");
    \u0275\u0275elementEnd();
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(5, _c02, step_r1.index === ctx_r1.currentStep));
    \u0275\u0275advance(2);
    \u0275\u0275classMap(step_r1.icon);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", step_r1.title, " ");
  }
}
var StepTrackerComponent = class _StepTrackerComponent {
  constructor(cdRef) {
    this.cdRef = cdRef;
    this.steps = [];
    this.currentStep = 0;
  ...
  static {
    this.\u0275fac = function StepTrackerComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _StepTrackerComponent)(\u0275\u0275directiveInject(ChangeDetectorRef));
    };
  }
  static {
    this.\u0275cmp = \u0275\u0275defineComponent({ type: _StepTrackerComponent, selectors: [["app-step-tracker"]], inputs: { steps: "steps", currentStep: "currentStep" }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 3, vars: 1, consts: [[1, "card", "card-timeline", "px-2", "mb-3", "border-none"], [1, "bs4-order-tracking"], [4, "ngFor", "ngForOf"], [1, "step", 3, "ngClass"]], template: function StepTrackerComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "ul", 1);
        \u0275\u0275template(2, StepTrackerComponent_ng_container_2_Template, 5, 7, "ng-container", 2);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        \u0275\u0275advance(2);
    ...
    }, dependencies: [CommonModule, NgClass, NgForOf], styles: ['\n\n.bs4-order-tracking[_ngcontent-%COMP%] {\n  overflow: hidden;\n  color: #878788;\n  padding-left: 0px;\n  margin-top: 30px;\n}\n.bs4-order-tracking[_ngcontent-%COMP%]   li[_ngcontent-%COMP%] {\n  list-style-type: none;\n  font-size: 17px;\n  width: 25%;\n  float: left;\n  position: relative;\n  font-weight: 400;\n  color: #878788;\n  text-align: center;\n}\n.bs4-order-tracking[_ngcontent-%COMP%]   li[_ngcontent-%COMP%]:first-child:before {\n  margin-left: 15px !important;\n  padding-left: 11px !important;\n  text-align: left !important;\n}\n.bs4-order-tracking[_ngcontent-%COMP%]   li[_ngcontent-%COMP%]:last-child:before {\n  margin-right: 5px !important;\n  padding-right: 11px !important;\n  text-align: right !important;\n}\n.bs4-order-tracking[_ngcontent-%COMP%]   li[_ngcontent-%COMP%]    > div[_ngcontent-%COMP%] {\n  color: #fff;\n  width: 50px;\n  text-align: center;\n  line-height: 50px;\n  display: block;\n  font-size: 20px;\n  background: #878788;\n  border-radius: 50%;\n  margin: auto;\n}\n.bs4-order-tracking[_ngcontent-%COMP%]   li[_ngcontent-%COMP%]:after {\n  content: "";\n  width: 150%;\n  height: 2px;\n  background: #878788;\n  position: absolute;\n  left: 0%;\n  right: 0%;\n  top: 25px;\n  z-index: -1;\n}\n.bs4-order-tracking[_ngcontent-%COMP%]   li[_ngcontent-%COMP%]:first-child:after {\n  left: 50%;\n}\n.bs4-order-tracking[_ngcontent-%COMP%]   li[_ngcontent-%COMP%]:last-child:after {\n  left: 0% !important;\n  width: 0% !important;\n}\n.bs4-order-tracking[_ngcontent-%COMP%]   li.active[_ngcontent-%COMP%] {\n  font-weight: bold;\n  color: var(--primary-color);\n}\n.bs4-order-tracking[_ngcontent-%COMP%]   li.active[_ngcontent-%COMP%]    > div[_ngcontent-%COMP%] {\n  background: var(--primary-color);\n}\n.bs4-order-tracking[_ngcontent-%COMP%]   li.active[_ngcontent-%COMP%]:after {\n  background: var(--primary-color);\n}\n.card-timeline[_ngcontent-%COMP%] {\n  z-index: 0;\n}\n/*# sourceMappingURL=step-tracker.component.css.map */'], changeDetection: 0 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(StepTrackerComponent, { className: "StepTrackerComponent", filePath: "src/app/reading-list/_components/step-tracker/step-tracker.component.ts", lineNumber: 21 });
})();

// src/app/reading-list/_components/import-cbl/import-cbl.component.ts
var _c03 = ["fileUpload"];
var _forTrack0 = ($index, $item) => $item.fileName;
var _forTrack1 = ($index, $item) => $item.order;
var _c12 = (a0, a1) => ({ summary: a0, filename: a1 });
var _c22 = (a0) => ({ summary: a0 });
function ImportCblComponent_ng_container_0_Case_4_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(t_r2("import-description"));
    \u0275\u0275advance();
    \u0275\u0275property("innerHTML", \u0275\u0275pipeBind1(4, 3, t_r2("cbl-repo")), \u0275\u0275sanitizeHtml);
    \u0275\u0275advance(2);
    \u0275\u0275property("formGroup", ctx_r2.uploadForm);
  }
}
function ImportCblComponent_ng_container_0_Case_5_For_6_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 23)(1, "h5", 24)(2, "button", 25);
    \u0275\u0275elementContainer(3, 26);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "div", 27)(5, "div", 28);
    \u0275\u0275elementContainer(6, 26);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const summary_r4 = ctx;
    const fileToProcess_r5 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275nextContext(2);
    const validationList_r6 = \u0275\u0275reference(9);
    const heading_r7 = \u0275\u0275reference(13);
    \u0275\u0275advance(3);
    \u0275\u0275property("ngTemplateOutlet", heading_r7)("ngTemplateOutletContext", \u0275\u0275pureFunction2(4, _c12, summary_r4, fileToProcess_r5.fileName));
    \u0275\u0275advance(3);
    \u0275\u0275property("ngTemplateOutlet", validationList_r6)("ngTemplateOutletContext", \u0275\u0275pureFunction1(7, _c22, summary_r4));
  }
}
function ImportCblComponent_ng_container_0_Case_5_For_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, ImportCblComponent_ng_container_0_Case_5_For_6_Conditional_0_Template, 7, 9, "div", 23);
  }
  if (rf & 2) {
    let tmp_17_0;
    const fileToProcess_r5 = ctx.$implicit;
    \u0275\u0275conditional((tmp_17_0 = fileToProcess_r5.validateSummary) ? 0 : -1, tmp_17_0);
  }
}
function ImportCblComponent_ng_container_0_Case_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "div", 8)(3, "div", 22, 3);
    \u0275\u0275repeaterCreate(5, ImportCblComponent_ng_container_0_Case_5_For_6_Template, 1, 1, null, null, _forTrack0);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const t_r2 = \u0275\u0275nextContext().$implicit;
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(t_r2("validate-description"));
    \u0275\u0275advance(4);
    \u0275\u0275repeater(ctx_r2.filesToProcess);
  }
}
function ImportCblComponent_ng_container_0_Case_6_For_6_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 23)(1, "h5", 24)(2, "button", 25);
    \u0275\u0275elementContainer(3, 26);
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    ...
    const fileToProcess_r9 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275nextContext(2);
    const resultsList_r10 = \u0275\u0275reference(11);
    const heading_r7 = \u0275\u0275reference(13);
    \u0275\u0275advance(3);
    \u0275\u0275property("ngTemplateOutlet", heading_r7)("ngTemplateOutletContext", \u0275\u0275pureFunction2(4, _c12, summary_r8, fileToProcess_r9.fileName));
    \u0275\u0275advance(3);
    \u0275\u0275property("ngTemplateOutlet", resultsList_r10)("ngTemplateOutletContext", \u0275\u0275pureFunction1(7, _c22, summary_r8));
  }
}
function ImportCblComponent_ng_container_0_Case_6_For_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, ImportCblComponent_ng_container_0_Case_6_For_6_Conditional_0_Template, 7, 9, "div", 23);
  }
  if (rf & 2) {
    let tmp_17_0;
    const fileToProcess_r9 = ctx.$implicit;
    \u0275\u0275conditional((tmp_17_0 = fileToProcess_r9.dryRunSummary) ? 0 : -1, tmp_17_0);
  }
}
function ImportCblComponent_ng_container_0_Case_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 8)(1, "p");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 22, 4);
    \u0275\u0275repeaterCreate(5, ImportCblComponent_ng_container_0_Case_6_For_6_Template, 1, 1, null, null, _forTrack0);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const t_r2 = \u0275\u0275nextContext().$implicit;
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(t_r2("dry-run-description"));
    \u0275\u0275advance(3);
    \u0275\u0275repeater(ctx_r2.filesToProcess);
  }
}
function ImportCblComponent_ng_container_0_Case_7_For_4_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 23)(1, "h5", 24)(2, "button", 25);
    \u0275\u0275elementContainer(3, 26);
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    const summary_r11 = ctx;
    const fileToProcess_r12 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275nextContext(2);
    const resultsList_r10 = \u0275\u0275reference(11);
    const heading_r7 = \u0275\u0275reference(13);
    \u0275\u0275advance(3);
    \u0275\u0275property("ngTemplateOutlet", heading_r7)("ngTemplateOutletContext", \u0275\u0275pureFunction2(4, _c12, summary_r11, fileToProcess_r12.fileName));
    \u0275\u0275advance(3);
    \u0275\u0275property("ngTemplateOutlet", resultsList_r10)("ngTemplateOutletContext", \u0275\u0275pureFunction1(7, _c22, summary_r11));
  }
}
function ImportCblComponent_ng_container_0_Case_7_For_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, ImportCblComponent_ng_container_0_Case_7_For_4_Conditional_0_Template, 7, 9, "div", 23);
  }
  if (rf & 2) {
    let tmp_17_0;
    const fileToProcess_r12 = ctx.$implicit;
    \u0275\u0275conditional((tmp_17_0 = fileToProcess_r12.finalizeSummary) ? 0 : -1, tmp_17_0);
  }
}
function ImportCblComponent_ng_container_0_Case_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 8)(1, "div", 22, 4);
    \u0275\u0275repeaterCreate(3, ImportCblComponent_ng_container_0_Case_7_For_4_Template, 1, 1, null, null, _forTrack0);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function ImportCblComponent_ng_container_0_ng_template_8_Conditional_0_For_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "li", 35);
    \u0275\u0275pipe(1, "cblConflictReason");
    \u0275\u0275pipe(2, "safeHtml");
  }
  if (rf & 2) {
    const result_r13 = ctx.$implicit;
    \u0275\u0275property("innerHTML", \u0275\u0275pipeBind1(2, 3, \u0275\u0275pipeBind1(1, 1, result_r13)), \u0275\u0275sanitizeHtml);
  }
}
function ImportCblComponent_ng_container_0_ng_template_8_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(6, "ol", 34);
    \u0275\u0275repeaterCreate(7, ImportCblComponent_ng_container_0_ng_template_8_Conditional_0_For_8_Template, 3, 5, "li", 35, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const summary_r14 = \u0275\u0275nextContext().summary;
    const t_r2 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", t_r2("validate-warning"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275repeater(summary_r14.results);
  }
}
function ImportCblComponent_ng_container_0_ng_template_8_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 29)(1, "div", 30)(2, "div", 31);
    \u0275\u0275element(3, "i", 36);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", t_r2("validate-no-issue-description"), " ");
  }
}
function ImportCblComponent_ng_container_0_ng_template_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, ImportCblComponent_ng_container_0_ng_template_8_Conditional_0_Template, 9, 1)(1, ImportCblComponent_ng_container_0_ng_template_8_Conditional_1_Template, 6, 1, "div", 29);
  }
  if (rf & 2) {
    const summary_r14 = ctx.summary;
    \u0275\u0275conditional(summary_r14.results.length > 0 ? 0 : 1);
  }
}
function ImportCblComponent_ng_container_0_ng_template_10_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "li", 35);
    \u0275\u0275pipe(1, "cblConflictReason");
    \u0275\u0275pipe(2, "safeHtml");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275propertyInterpolate2("innerHTML", "", result_r15.order + 1, ". ", \u0275\u0275pipeBind1(2, 5, \u0275\u0275pipeBind1(1, 3, result_r15)), "", \u0275\u0275sanitizeHtml);
  }
}
function ImportCblComponent_ng_container_0_ng_template_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ul", 37);
    \u0275\u0275repeaterCreate(1, ImportCblComponent_ng_container_0_ng_template_10_For_2_Template, 3, 7, "li", 35, _forTrack1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const summary_r16 = ctx.summary;
    \u0275\u0275advance();
    \u0275\u0275repeater(summary_r16.results);
  }
}
function ImportCblComponent_ng_container_0_ng_template_12_Case_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 38);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "cblImportResult");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const summary_r17 = \u0275\u0275nextContext().summary;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(2, 1, summary_r17.success));
  }
}
function ImportCblComponent_ng_container_0_ng_template_12_Case_1_Template(rf, ctx) {
  if (rf & 1) {
...
function ImportCblComponent_ng_container_0_ng_template_12_Case_2_Template(rf, ctx) {
  if (rf & 1) {
...
function ImportCblComponent_ng_container_0_ng_template_12_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const summary_r17 = \u0275\u0275nextContext().summary;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(": (", summary_r17.cblName, ")");
  }
}
function ImportCblComponent_ng_container_0_ng_template_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, ImportCblComponent_ng_container_0_ng_template_12_Case_0_Template, 3, 3, "span", 38)(1, ImportCblComponent_ng_container_0_ng_template_12_Case_1_Template, 3, 3, "span", 39)(2, ImportCblComponent_ng_container_0_ng_template_12_Case_2_Template, 3, 3, "span", 40);
    \u0275\u0275elementStart(3, "span");
    \u0275\u0275text(4);
    \u0275\u0275template(5, ImportCblComponent_ng_container_0_ng_template_12_Conditional_5_Template, 2, 1, "span");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_8_0;
    const filename_r18 = ctx.filename;
    const summary_r17 = ctx.summary;
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275conditional((tmp_8_0 = summary_r17.success) === ctx_r2.CblImportResult.Success ? 0 : tmp_8_0 === ctx_r2.CblImportResult.Fail ? 1 : tmp_8_0 === ctx_r2.CblImportResult.Partial ? 2 : -1);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("", filename_r18, " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(summary_r17.cblName ? 5 : -1);
  }
}
function ImportCblComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "div", 6);
    \u0275\u0275element(2, "app-step-tracker", 7);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div");
    \u0275\u0275template(4, ImportCblComponent_ng_container_0_Case_4_Template, 7, 5, "div", 8)(5, ImportCblComponent_ng_container_0_Case_5_Template, 7, 1)(6, ImportCblComponent_ng_container_0_Case_6_Template, 7, 1, "div", 8)(7, ImportCblComponent_ng_container_0_Case_7_Template, 5, 0, "div", 8);
    \u0275\u0275elementEnd();
    \u0275\u0275template(8, ImportCblComponent_ng_container_0_ng_template_8_Template, 2, 1, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(10, ImportCblComponent_ng_container_0_ng_template_10_Template, 3, 0, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(12, ImportCblComponent_ng_container_0_ng_template_12_Template, 6, 3, "ng-template", null, 2, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementStart(14, "div", 9)(15, "form", 10)(16, "div", 11)(17, "div", 12);
    ...
    \u0275\u0275text(24);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(25, "div", 16)(26, "button", 18);
    \u0275\u0275listener("click", function ImportCblComponent_ng_container_0_Template_button_click_26_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(27);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(28, "div", 16)(29, "button", 18);
    \u0275\u0275listener("click", function ImportCblComponent_ng_container_0_Template_button_click_29_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r2 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275property("steps", ctx_r2.steps)("currentStep", ctx_r2.currentStepIndex);
    \u0275\u0275advance(2);
    \u0275\u0275conditional((tmp_7_0 = ctx_r2.currentStepIndex) === ctx_r2.Step.Import ? 4 : tmp_7_0 === ctx_r2.Step.Validate ? 5 : tmp_7_0 === ctx_r2.Step.DryRun ? 6 : tmp_7_0 === ctx_r2.Step.Finalize ? 7 : -1);
    \u0275\u0275advance(11);
    \u0275\u0275property("formGroup", ctx_r2.cblSettingsForm);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(t_r2("comicvine-parsing-label"));
    \u0275\u0275advance(3);
    \u0275\u0275property("href", ctx_r2.WikiLink.ReadingListCBL, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(t_r2("help-label"));
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", !ctx_r2.canMoveToPrevStep());
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(t_r2("prev"));
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", !ctx_r2.canMoveToNextStep());
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(t_r2(ctx_r2.NextButtonLabel));
  }
}
var Step;
(function(Step2) {
  Step2[Step2["Import"] = 0] = "Import";
  Step2[Step2["Validate"] = 1] = "Validate";
  Step2[Step2["DryRun"] = 2] = "DryRun";
  Step2[Step2["Finalize"] = 3] = "Finalize";
})(Step || (Step = {}));
var ImportCblComponent = class _ImportCblComponent {
  constructor() {
    this.readingListService = inject(ReadingListService);
    this.toastr = inject(ToastrService);
    this.cdRef = inject(ChangeDetectorRef);
    this.utilityService = inject(UtilityService);
    this.CblImportResult = CblImportResult;
    this.Step = Step;
    this.WikiLink = WikiLink;
    this.fileUploadControl = new FormControl(void 0, [
      FileUploadValidators.accept([".cbl"])
    ]);
    this.uploadForm = new FormGroup({
      files: this.fileUploadControl
    });
    this.cblSettingsForm = new FormGroup({
  ...
  nextStep() {
    if (this.currentStepIndex === Step.Import && !this.isFileSelected())
      return;
    this.isLoading = true;
    switch (this.currentStepIndex) {
      case Step.Import:
        ...
        for (let i = 0; i < files.length; i++) {
          ...
          pages.push(this.readingListService.validateCbl(formData, true, this.cblSettingsForm.get("comicVineMatching")?.value));
        }
        forkJoin(pages).subscribe((results) => {
          ...
          results.forEach((cblImport) => {
            this.filesToProcess.push({
              ...
              dryRunSummary: void 0,
              finalizeSummary: void 0
            });
          });
      ...
      case Step.DryRun:
        ...
        break;
      case Step.Finalize:
        this.uploadForm.get("files")?.setValue(void 0);
  ...
  dryRun() {
    ...
    for (let i = 0; i < files.length; i++) {
      ...
      formData.append("dryRun", "true");
      formData.append("comicVineMatching", this.cblSettingsForm.get("comicVineMatching")?.value + "");
      pages.push(this.readingListService.importCbl(formData, true, this.cblSettingsForm.get("comicVineMatching")?.value));
    }
    forkJoin(pages).subscribe((results) => {
      results.forEach((cblImport) => {
  ...
  import() {
    ...
    for (let i = 0; i < files.length; i++) {
      ...
      formData.append("comicVineMatching", this.cblSettingsForm.get("comicVineMatching")?.value + "");
      pages.push(this.readingListService.importCbl(formData, false, this.cblSettingsForm.get("comicVineMatching")?.value));
    }
    forkJoin(pages).subscribe((results) => {
      results.forEach((cblImport) => {
        const index = this.filesToProcess.findIndex((p) => p.fileName === cblImport.fileName);
  ...
  static {
    this.\u0275fac = function ImportCblComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _ImportCblComponent)();
    };
  }
  static {
    this.\u0275cmp = \u0275\u0275defineComponent({ type: _ImportCblComponent, selectors: [["app-import-cbl"]], viewQuery: function ImportCblComponent_Query(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275viewQuery(_c03, 5);
      }
      if (rf & 2) {
    ...
    }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 1, vars: 1, consts: [["validationList", ""], ["resultsList", ""], ["heading", ""], ["accordion", "ngbAccordion"], ["a", "ngbAccordion"], [4, "transloco", "translocoRead"], [1, "row", "g-0", 2, "min-width", "135px"], [3, "steps", "currentStep"], [1, "row", "g-0"], [1, "modal-footer", "mt-3"], [1, "row", "align-items-center", 3, "formGroup"], [1, "col-auto"], [1, "form-check", "form-switch"], ["type", "checkbox", "id", "settings-comicvine-mode", "role", "switch", "formControlName", "comicVineMatching", "aria-labelledby", "auto-close-label", 1, "form-check-input"], ["for", "settings-comicvine-mode", 1, "form-check-label"], ["aria-hidden", "true", 1, "col"], [1, "col-auto", "ms-1"], ["target", "_blank", "rel", "noopener noreferrer", 1, "btn", "btn-icon", 3, "href"], ["type", "button", 1, "btn", "btn-primary", 3, "click", "disabled"], [3, "innerHTML"], ["enctype", "multipart/form-data", 3, "formGroup"], ["formControlName", "files"], ["ngbAccordion", ""], ["ngbAccordionItem", ""], ["ngbAccordionHeader", ""], ["ngbAccordionButton", ""], [3, "ngTemplateOutlet", "ngTemplateOutletContext"], ["ngbAccordionCollapse", ""], ["ngbAccordionBody", ""], [1, "justify-content-center", "col"], [1, "d-flex", "align-items-center"], [1, "flex-shrink-0"], ["aria-hidden", "true", 1, "fa-solid", "fa-triangle-exclamation", 2, "font-size", "24px"], [1, "flex-grow-1", "ms-3"], [1, "list-group", "list-group-numbered", "list-group-flush"], [1, "list-group-item", "no-hover", 3, "innerHTML"], ["aria-hidden", "true", 1, "fa-solid", "fa-circle-check", 2, "font-size", "24px"], [1, "list-group", "list-group-flush"], [1, "badge", "heading-badge", "bg-primary", "me-1"], [1, "badge", "heading-badge", "bg-danger", "me-1"], [1, "badge", "heading-badge", "bg-warning", "me-1"]], template: function ImportCblComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275template(0, ImportCblComponent_ng_container_0_Template, 31, 11, "ng-container", 5);
      }
      if (rf & 2) {
        \u0275\u0275property("translocoRead", "import-cbl-modal");
      }
    }, dependencies: [
      ...
      TranslocoDirective,
      NgTemplateOutlet
    ], styles: ["\n\n.file-input[_ngcontent-%COMP%] {\n  display: none;\n}\n.heading-badge[_ngcontent-%COMP%] {\n  color: var(--bs-badge-color);\n}\n  .file-info {\n  width: 83%;\n  float: left;\n}\n  .file-buttons {\n  float: right;\n}\nfile-upload[_ngcontent-%COMP%] {\n  background: none;\n  height: auto;\n}\n  .upload-input {\n  color: var(--input-text-color) !important;\n}\n  file-upload-list-item {\n  color: var(--input-text-color) !important;\n}\n  .remove-btn {\n  background: #C0392B;\n  border-radius: 3px;\n  color: var(--input-text-color) !important;\n  font-weight: bold;\n  padding: 3px 5px;\n}\n  .reading-list-success--item {\n  color: var(--primary-color);\n}\n  .reading-list-fail--item {\n  color: var(--error-color);\n}\n/*# sourceMappingURL=import-cbl.component.css.map */"], changeDetection: 0 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ImportCblComponent, { className: "ImportCblComponent", filePath: "src/app/reading-list/_components/import-cbl/import-cbl.component.ts", lineNumber: 65 });
})();
export {
  ImportCblComponent
};
//# sourceMappingURL=import-cbl.component-IHK2YE2F.js.map
